...
var MessageExample = /** @class */ (function (_super) {
    ...
    function MessageExample() {
        ...
        _this.start = 0x00;
        _this.head = new Buffer([0x01, 0x02, 0x03, 0x04]);
        _this.data = new Buffer([0x05, 0x06, 0x07, 0x08, 0x09]);
        _this.end = 0xFF;
        _this.CRC = {
    ...
    __decorate([
        ...
        serializerInfo_1.SerializerInfo.ingnoreDeserialize,
    ...
    __decorate([
        ...
        serializerInfo_1.SerializerInfo.lenght(5),
        serializerInfo_1.SerializerInfo.propertyType(propertyType_1.PropertyType.Buffer),
        __metadata("design:type", Buffer)
